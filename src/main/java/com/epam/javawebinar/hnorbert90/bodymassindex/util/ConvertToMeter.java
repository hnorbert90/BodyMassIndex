...
public class ConvertToMeter {
     ...
     final static double FEET_TO_METER = 0.3048;
     final static double INCH_TO_METER = 0.0254;
     final static double YARD_TO_METER = 0.9144;
     final static double MILLIMETER_TO_METER = 0.001;
     final static double CENTIMETER_TO_METER = 0.01;
     final static double DECIMETER_TO_METER = 0.1;
